...
const fileFilter = (req, file, cb) => {
    ...
    // Photo filter
    if (file.fieldname === "StudentPhoto" || file.fieldname === "InstructorPhoto") {
    ...
    // PDF filter
    else if (file.fieldname === "coursePdfs" || file.fieldname === "InstructorCertificate") {
